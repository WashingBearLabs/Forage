...
(``git show v1.2.1:contract/openapi.yaml.sha256 > anchor.sha256`` after the cut,
...
Run it by hand against a container, or anything else serving the contract::
    ...
    # after the v1.2.1 cut: a weights-loaded container and its tagged anchor
    anchor="$(mktemp)"
    git show v1.2.1:contract/openapi.yaml.sha256 > "$anchor"
    uv run python contract_smoke.py --base-url http://127.0.0.1:8020 \
