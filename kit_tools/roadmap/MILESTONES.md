...
**Current target:** Forage `v1.2.1` — the hardened image (`epic-forage-hardening`, T2.2):
...
**Status:** Release recovery (2026-09-23). v1.2.0 published but rejected the real
default model; the owner authorized v1.2.1 and withdrawal after verification.
...
- [ ] **v1.2.1 / T2.2 Forage hardening** (`epic-forage-hardening`, planned 2026-09-19, eight
      ...
      86M vendoring (spec 7 US-002), benchmark (spec 7 US-004), the replacement
      cut (spec 8 US-003), and verification/handoff (spec 8 US-005). The first
      two have explicit gate-not-run records; release recovery remains open. See
...
of truth. Forage-side sequence after `v1.1.0`: `epic-forage-hardening` (`v1.2.1`, planned
