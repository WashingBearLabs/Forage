...
smoke drivers and 1,443 lines of operator scripts under `scripts/`, none of which ship in
...
├── tests/                   # 29 files; flat, one module per subject
