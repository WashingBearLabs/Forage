...
The current release is **v1.2.1 / contract 1.3.0**, published and verified
2026-09-23. The merge-to-publication window is closed; `docs/releases.md`
records its duration and the withdrawal of defective v1.2.0.
...
metadata, and the image tag (`v1.2.1`) and `contract_version` (`1.3.0`)
