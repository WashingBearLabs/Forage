...
| Tests | 4126 collected (`uv run pytest --collect-only -q`, 2026-09-23); PR #30 full-suite CI: **4120 passed, 6 xfailed**, not inferred from collection or scoped passes. Hermetic via `pytest-socket`, **enforced in CI**, with a committed hermeticity canary |
