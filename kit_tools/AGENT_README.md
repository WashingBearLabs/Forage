...
- [ ] Confirm the environment: `uv sync --extra dev && uv run pytest` (expect ALL green, zero failures — the current count lives in `kit_tools/testing/TESTING_GUIDE.md`; 1151 as of spec-2 US-003's build half)
